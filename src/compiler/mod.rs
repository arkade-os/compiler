...
use crate::opcodes::{
    ...
    OP_NEGATE, OP_NIP, OP_NOT, OP_NUM2BIN, OP_NUMEQUAL, OP_PUSHCURRENTINPUTINDEX, OP_REVERSEBYTES,
    OP_SHA256, OP_SHA256FINALIZE, OP_SHA256INITIALIZE, OP_SHA256UPDATE, OP_SIZE, OP_SUB, OP_SUBSTR,
    OP_SWAP, OP_TWEAKVERIFY, OP_TXID, OP_TXWEIGHT, OP_VERIFY,
};
use crate::parser;
