...
fn invalid_function_signatures_calls_and_returns_are_rejected() {
    let cases = [
        ...
        ("function spend() { require(true); } private function helper() int { return helper(); }", "recursive function call"),
        ("function spend() { require(true); } private function a() { b(); } private function b() { a(); }", "recursive function call"),
